...
const styles = StyleSheet.create({
  ...
  unread: { borderLeftWidth: 3, borderLeftColor: colors.oliveGold },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: 'transparent' },
  dotActive: { backgroundColor: colors.oliveGold },
  notifContent: { flex: 1 },
  notifTitle: {
    fontFamily: typography.fontFamily.medium, fontSize: typography.sizes.body,
    color: colors.graphite, marginBottom: spacing.xxs,
  },
  notifTitleUnread: { fontFamily: typography.fontFamily.bold },
  notifBody: {
    fontFamily: typography.fontFamily.regular, fontSize: typography.sizes.subheadline,
    color: colors.icon, marginBottom: spacing.xs,
  },
  notifTime: { fontFamily: typography.fontFamily.regular, fontSize: typography.sizes.caption, color: colors.placeholder },
  markAllBtn: { paddingHorizontal: spacing.md, paddingVertical: spacing.xs },
  markAllText: { fontFamily: typography.fontFamily.semibold, fontSize: typography.sizes.subheadline, color: colors.oliveGold },
});
